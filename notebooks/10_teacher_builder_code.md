...
# Teacher Builder Code

Tracked source inventory and selected code for the governed teacher-builder workflow. This page does not run teacher-builder or inspect local ignored outputs.
...
rows = script_rows(['prediction_modeling_pipeline/teacher_builder/'])
...
body += "<p class='report-note'>The teacher-builder scripts validate upstream inputs, build expression and histology teacher signals, fuse governed labels, prepare modeling tables, and run teacher QC.</p>"
body += "<h2>Selected Source Code</h2>"
for path in ['prediction_modeling_pipeline/teacher_builder/run_teacher_builder_governed.ps1', 'prediction_modeling_pipeline/teacher_builder/scripts/01_validate_teacher_inputs.py', 'prediction_modeling_pipeline/teacher_builder/scripts/03_build_histology_teacher.py', 'prediction_modeling_pipeline/teacher_builder/scripts/04_fuse_teacher_tables.py', 'prediction_modeling_pipeline/teacher_builder/scripts/06_qc_teacher_outputs.py']:
