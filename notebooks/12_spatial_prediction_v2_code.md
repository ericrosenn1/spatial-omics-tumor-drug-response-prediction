...
# Spatial Prediction Model V2 Code

Tracked source inventory and selected code for the V2 spatial prediction scaffold. This page does not train, score, or validate model outputs.
...
rows = script_rows(['prediction_modeling_pipeline/spatial_prediction_model_V2/'])
...
body += "<p class='report-note'>The V2 spatial prediction code separates CLI stages from reusable modules for data discovery, modeling-dataset construction, residual modeling, feature governance, interpretation, and QC.</p>"
body += "<h2>Selected Source Code</h2>"
for path in ['prediction_modeling_pipeline/spatial_prediction_model_V2/scripts/00_run_spatial_prediction_model_v2.py', 'prediction_modeling_pipeline/spatial_prediction_model_V2/scripts/01_validate_inputs.py', 'prediction_modeling_pipeline/spatial_prediction_model_V2/scripts/04_train_pair_level_residual_model.py', 'prediction_modeling_pipeline/spatial_prediction_model_V2/src/spm_v2/dataset_builder.py', 'prediction_modeling_pipeline/spatial_prediction_model_V2/src/spm_v2/model_training.py', 'prediction_modeling_pipeline/spatial_prediction_model_V2/tests/test_repository_integrity.py']:
