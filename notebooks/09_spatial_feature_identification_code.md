...
# Spatial Feature Identification Code

Tracked source inventory and selected code from the spatial feature identification pipeline. This page does not execute the pipeline or read ignored outputs.
...
rows = script_rows(['spatial_feature_identification_pipeline/'])
...
body += "<p class='report-note'>These scripts validate inputs, process Visium samples, build spatial feature tables, add labels/context metrics, and create the model-ready feature handoff.</p>"
body += "<h2>Selected Source Code</h2>"
for path in ['spatial_feature_identification_pipeline/run_pipeline.py', 'spatial_feature_identification_pipeline/code/01_validate_inputs.py', 'spatial_feature_identification_pipeline/code/10_build_model_ready_table.py', 'spatial_feature_identification_pipeline/code/lib/config.py']:
