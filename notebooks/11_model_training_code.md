...
Tracked source inventory and selected code for expression and histology response model training modules. This page does not train models.
...
rows = script_rows(['prediction_modeling_pipeline/model_training/'])
...
body += "<p class='report-note'>The model-training modules organize treatment ontology construction, data validation, deployable expression-response models, histology-response models, control inference, and audit steps.</p>"
body += "<h2>Selected Source Code</h2>"
for path in ['prediction_modeling_pipeline/model_training/expression_response_model_v2/run_expression_response_model_v2.ps1', 'prediction_modeling_pipeline/model_training/expression_response_model_v2/scripts/00_build_treatment_ontology.py', 'prediction_modeling_pipeline/model_training/expression_response_model_v2/scripts/03_train_deployable_models.py', 'prediction_modeling_pipeline/model_training/expression_response_model_v2/scripts/expression_model_v2_lib.py', 'prediction_modeling_pipeline/model_training/histology_response_model_v2/run_histology_response_model_v2.ps1', 'prediction_modeling_pipeline/model_training/histology_response_model_v2/scripts/00_build_treatment_ontology.py', 'prediction_modeling_pipeline/model_training/histology_response_model_v2/scripts/07_train_baselines_and_conditioned_model.py', 'prediction_modeling_pipeline/model_training/histology_response_model_v2/scripts/histology_model_v2_lib.py']:
