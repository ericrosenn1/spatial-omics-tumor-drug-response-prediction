...
# Interpretation And Transfer Code

Tracked source inventory and selected code for prediction interpretation and spatial transfer inference. This page does not run inference.
...
rows = script_rows(['prediction_modeling_pipeline/prediction_interpretation_model/', 'prediction_modeling_pipeline/spatial_transfer_inference_model/'])
body = "<h2>Script Inventory</h2>" + html_table(rows, ["path", "lines", "last commit", "date", "purpose", "header/docstring", "CLI"], numeric_columns={"lines"}, path_columns={"path"})
body += "<p class='report-note'>These scripts package signed spatial effects, treatment interpretation cards, mechanism atlases, strict feature alignment, transfer scoring, and transfer QC handoffs.</p>"
body += "<h2>Selected Source Code</h2>"
for path in ['prediction_modeling_pipeline/prediction_interpretation_model/scripts/00_run_prediction_interpretation_model.py', 'prediction_modeling_pipeline/prediction_interpretation_model/scripts/03_compute_signed_spatial_effects.py', 'prediction_modeling_pipeline/prediction_interpretation_model/scripts/06_build_mechanism_atlas.py', 'prediction_modeling_pipeline/prediction_interpretation_model/scripts/_pim_utils.py', 'prediction_modeling_pipeline/spatial_transfer_inference_model/scripts/00_run_spatial_transfer_inference_model.py', 'prediction_modeling_pipeline/spatial_transfer_inference_model/scripts/02_align_single_slide_features_to_v2.py', 'prediction_modeling_pipeline/spatial_transfer_inference_model/scripts/03_score_transfer_drug_response_alignment.py', 'prediction_modeling_pipeline/spatial_transfer_inference_model/scripts/_stim_utils.py']:
    body += code_details(path)
render_page(body)
```
