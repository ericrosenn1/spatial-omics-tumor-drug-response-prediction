# expression_response_model_v2 configs

Tracked template:

- expression_response_model_v2.example.yaml

For local runs, copy the tracked template to the runtime filename expected by the runner and edit local paths there:

```powershell
Copy-Item .\expression_response_model_v2.example.yaml .\expression_response_model_v2.yaml
```
